...
used in pre-aggregations when using AWS Redshift as a source database. To learn
more about AWS Redshift's support for approximate aggregate functions, [click
here][aws-redshift-docs-approx-agg-fns].
...
[aws-redshift-docs-approx-agg-fns]:
